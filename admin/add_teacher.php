<?php
    ...
    $mass=teacher::saveTeacher($_POST);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="card">
                            <div class="card-heading bg-dark p-3">
                                <h3 class="text-center text-light">Add Teacher</h3>
                            </div>
                            <div class="card-body bg-light">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success btn-block" name="s_ok" value="Save Teacher" />
                                    </div>
                                </form>
                            </div>
                        </div>
