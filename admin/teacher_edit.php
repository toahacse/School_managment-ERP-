<?php
    ...
    $id=$_GET['id'];
    $queryResult = teacher::viewTeacherById($id);
    $p = mysqli_fetch_assoc($queryResult);
    teacher::updateTeacher($_POST,$id);
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="card">
                                <div class="card-heading bg-dark p-3">
                                    <h3 class="text-center text-light">Update Teacher</h3>
                                </div>
                                <div class="card-body bg-light">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="categoryName">Department:</label>
                                            <select class="form-control" name="department" required>
                                                <option><?php echo $p['department']?></option>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-success btn-block" name="ok" value="Update Teacher" />
                                        </div>
                                    </form>
                                </div>
                            </div>
