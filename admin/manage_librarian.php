<?php
    ...
    $queryResult = librarian::viewLibrarian();
    $i=1;
    $mass='';

    if(isset($_GET['delete'])){
        $id=$_GET['id'];
        $mass = librarian::deleteLibrarian($id);
    }
?>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="card">
                                <div class="card-heading bg-dark p-3">
                                    <h3 class="text-center text-light">Manage Librarian</h3>
                                </div>
                                <div class="card-body">
                                    <?php echo $mass;?>
                                        ...
                                        <table class="table table-bordered">
                                                ...
                                                <?php while($p = mysqli_fetch_assoc($queryResult)){?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="librarian_edit.php?id=<?php echo $p['id'];?>" class="btn btn-success btn-xs">
