<?php
    ...
    $id=$_GET['id'];
    $queryResult = assignment::viewAssignmentById($id);
    $p = mysqli_fetch_assoc($queryResult);
    assignment::updateAssignment($_POST,$id);
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="card">
                                <div class="card-heading bg-dark p-3">
                                    <h3 class="text-center text-light">Update Assignment</h3>
                                </div>
                                <div class="card-body bg-light">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-success btn-block" name="ok" value="Update Assignment" />
                                        </div>
                                    </form>
                                </div>
                            </div>
